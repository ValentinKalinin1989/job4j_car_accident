...
public class AccidentMen {
    ...
    public AccidentMen() {
        ...
        accidents.put(9L, new Accident(9L, "Декард Шоу", "Сбил китайца", "Какой-то город в Китае, проспект Ленина"));
        accidents.put(10L, new Accident(10L, "Билли Бутчер", "Сбил человека-невидимку", "Нью-Йорк, магазин видео-аудио техники"));
